      ...
      <div style={styles.content}>
        <div style={styles.wrapper}>
          ...
          <div style={styles.illustration}>
            ...
            <div style={styles.illTitle}>Welcome to EasRent</div>
            <div style={styles.illSubtitle}>Find your perfect apartment and start your journey with us today.</div>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={styles.checkbox}>
                <input
                  ...
                  style={{ cursor: "pointer", accentColor: "#FF385C" }}
                />
